...
export default () => (
  <svg xmlns="http://www.w3.org/2000/svg" style={{display: 'none'}}>
    ...
    >
      <defs>
        <path d="M24 24H0V0h24v24z" id="aga" />
      </defs>
      <clipPath id="agb">
        <use overflow="visible" xlinkHref="#aga" />
      </clipPath>
      <path
        clipPath="url(#agb)"
    ...
    <symbol viewBox="0 0 24 24" id="archive" xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="clear" xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="comment" xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="create" xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="done" xmlns="http://www.w3.org/2000/svg">
      <path d="M0 0h24v24H0z" fill="none" />
    ...
    <symbol viewBox="0 0 24 24" id="globe" xmlns="http://www.w3.org/2000/svg">
      <path d="M14.384 2.174l-1.908.168-.897-.138-.616.91-1.797.093-1.124-.305-1 .515-2.168.285-1.737.472H3.13C5.367 1.624 8.755 0 12.543 0c1.861 0 3.618.404 5.196 1.103l-.437.062-1.198-.17-.847.532-.592.614.882.174.982.885.304.786.227.736 1.563 1.416.402.129.555-.89 1.964-.176.369-.118A12.373 12.373 0 0 1 24 11.973 12.366 12.366 0 0 1 14.57 24l.224-.818 2.116-1.42.555-1.519 1.461-.683 1.385-2.659-2.141-1.265-1.11-1.266-.654-.077-1.31-.354-1.129-.179-.988.28-.605-.684-.605-.178.05-.91-.73.023-.416.482-.238-1.013.955-.456.984.456h.529l.191-.785L14.565 9.2l2.043-1.037 1.183.152.107-.581-1.466-1.495-.553-1.114h-.808l-.504-.296-1.084-.16-.227 1.293-1.312-.254-.1-.81 1.008-.229.331-1.452 1 .414-.026.617.762.32.509.15.624-.328-.555-.658L14.36 2.62l.023-.446zm-.354 15.929s.578 1.919.579 1.995c0 .075-.578 2.298-.578 2.298l.131 1.496a13.42 13.42 0 0 1-1.579.108C5.633 24 0 18.468 0 11.648c0-2.274.636-4.396 1.727-6.225l.906-.206-.908.707.712.457H3.85l2.099-.367 1.322 2.11v1.971l1.803 2.4h.307v-.846l.694 1.426 2.093.461.945.931.84.247-.84 1.72.916 1.669zm.354-15.929l.272-.024.009-.009-.277-.054-.004.087zm-1.325-1.032l-.716.42.498.303 1.106-.104 1.16-.83-.801-.435-1.247.646zm-3.692.094c-.018.137-.8.61-.8.61l.8.44 1.663-.41-.392-.64-.72.215-.551-.215z" />
    </symbol>
    <symbol viewBox="0 0 24 24" id="group" xmlns="http://www.w3.org/2000/svg">
      <path d="M0 0h24v24H0z" fill="none" />
    ...
    >
      ...
      <path d="M12 20l-.86-.86a2.997 2.997 0 0 1 .02-4.26l.84-.82a9.34 9.34 0 0 0-1-.06c-2.67 0-8 1.34-8 4v2h9zm-1-8c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4m5.18 7.78c-.39.39-1.03.39-1.42 0l-2.07-2.09a.99.99 0 0 1 0-1.39l.01-.01a.984.984 0 0 1 1.4 0l1.37 1.37 4.43-4.46a.996.996 0 0 1 1.41 0l.01.01a.99.99 0 0 1 0 1.39l-5.14 5.18z" />
    </symbol>
    ...
    <symbol
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <path d="M19.64 12.98c.042-.32.073-.64.073-.98s-.031-.66-.072-.98l2.169-1.65a.495.495 0 0 0 .123-.64l-2.056-3.46a.524.524 0 0 0-.627-.22l-2.56 1c-.534-.4-1.11-.73-1.737-.98l-.39-2.65a.497.497 0 0 0-.505-.42H9.946a.497.497 0 0 0-.504.42l-.39 2.65c-.627.25-1.203.59-1.738.98l-2.56-1a.508.508 0 0 0-.627.22L2.071 8.73a.484.484 0 0 0 .124.64l2.169 1.65c-.041.32-.072.65-.072.98s.03.66.072.98l-2.17 1.65a.495.495 0 0 0-.123.64l2.056 3.46c.124.22.401.3.627.22l2.56-1c.535.4 1.11.73 1.738.98l.39 2.65c.031.24.247.42.504.42h4.112c.257 0 .473-.18.504-.42l.39-2.65a7.955 7.955 0 0 0 1.738-.98l2.56 1c.236.09.504 0 .627-.22l2.056-3.46a.495.495 0 0 0-.123-.64zm-7.638 2.52c-1.984 0-3.598-1.57-3.598-3.5s1.614-3.5 3.598-3.5S15.6 10.07 15.6 12s-1.614 3.5-3.598 3.5z" />
      <path d="M0 0h24v24H0z" fill="none" />
    </symbol>
    <symbol
      viewBox="0 0 24 24"
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <path d="M11.963 2v1.373H5.614c-.618 0-1.12.462-1.12 1.03v13.975H3V4.403C3 3.076 4.17 2 5.614 2zM7.928 4.833h11.205c1.03 0 1.867.768 1.867 1.716v13.734c0 .948-.836 1.717-1.867 1.717H7.928c-1.031 0-1.867-.769-1.867-1.717V6.55c0-.948.836-1.716 1.867-1.716zm5.602 9.442c1.29 0 2.335-.96 2.335-2.146S14.82 9.983 13.53 9.983s-2.334.96-2.334 2.146 1.045 2.146 2.334 2.146zm0 1.073c-1.558 0-4.668.719-4.668 2.146v.536c0 .295.263.537.584.537h8.17c.32 0 .583-.242.583-.537v-.536c0-1.427-3.11-2.146-4.669-2.146z" />
      <path d="M0 0h24v24H0z" fill="none" />
    </symbol>
    <symbol
      viewBox="0 0 24 24"
    ...
    <symbol
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <path d="M19.2 3H4.8C3.81 3 3 3.81 3 4.8V21l3.6-3.6h12.6c.99 0 1.8-.81 1.8-1.8V4.8c0-.99-.81-1.8-1.8-1.8z" />
      <path d="M0 0h24v24H0z" fill="none" />
    </symbol>
    <symbol
      viewBox="0 0 24 24"
    ...
    <symbol
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <path d="M19 4h-4.18C14.4 2.84 13.3 2 12 2s-2.4.84-2.82 2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm-7 0c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zM9.29 17.29L6.7 14.7a.996.996 0 1 1 1.41-1.41L10 15.17l5.88-5.88a.996.996 0 1 1 1.41 1.41l-6.59 6.59a.996.996 0 0 1-1.41 0z" />
      <path d="M0 0h24v24H0z" fill="none" />
    </symbol>
    <symbol
      viewBox="0 0 24 24"
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <path d="M19.778 2H4.222C3 2 2 3 2 4.222v15.556C2 21 3 22 4.222 22h15.556C21 22 22 21 22 19.778V4.222C22 3 21 2 19.778 2zM7.556 17.556c-.612 0-1.112-.5-1.112-1.112V10.89c0-.611.5-1.111 1.112-1.111.61 0 1.11.5 1.11 1.11v5.556c0 .612-.5 1.112-1.11 1.112zm4.444 0c-.611 0-1.111-.5-1.111-1.112V7.556c0-.612.5-1.112 1.111-1.112s1.111.5 1.111 1.112v8.888c0 .612-.5 1.112-1.111 1.112zm4.444 0c-.61 0-1.11-.5-1.11-1.112v-2.222c0-.61.5-1.11 1.11-1.11.612 0 1.112.5 1.112 1.11v2.222c0 .612-.5 1.112-1.112 1.112z" />
      <path d="M0 0h24v24H0z" fill="none" />
    </symbol>
    <symbol
      viewBox="0 0 24 24"
    ...
    <symbol viewBox="0 0 24 24" id="launch" xmlns="http://www.w3.org/2000/svg">
      <path d="M0 0h24v24H0z" fill="none" />
    ...
    <symbol viewBox="0 0 24 24" id="loop" xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol viewBox="0 0 24 24" id="payment" xmlns="http://www.w3.org/2000/svg">
      <path d="M0 0h24v24H0z" fill="none" />
      <path d="M20 4H4c-1.11 0-1.99.89-1.99 2L2 18c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V6c0-1.11-.89-2-2-2zm0 14H4v-6h16v6zm0-10H4V6h16v2z" />
    </symbol>
    ...
    >
      <defs>
        <path d="M0 0h24v24H0V0z" id="dta" />
      </defs>
      <clipPath id="dtb">
        <use overflow="visible" xlinkHref="#dta" />
      </clipPath>
      <path
        clipPath="url(#dtb)"
    ...
    <symbol viewBox="0 0 24 24" id="receipt" xmlns="http://www.w3.org/2000/svg">
    ...
    >
      <defs>
        <path d="M0 0h24v24H0V0z" id="eea" />
      </defs>
      <clipPath id="eeb">
        <use overflow="visible" xlinkHref="#eea" />
      </clipPath>
      <path clipPath="url(#eeb)" d="M4 9h16v2H4zm0 4h10v2H4z" />
    </symbol>
    ...
    <symbol viewBox="0 0 24 24" id="twitter" xmlns="http://www.w3.org/2000/svg">
      <path d="M24 5.2a10.23 10.23 0 0 1-2.828.738c1.017-.58 1.797-1.5 2.165-2.595-.951.538-2.005.928-3.127 1.138A5.034 5.034 0 0 0 16.616 3c-2.72 0-4.924 2.1-4.924 4.69 0 .368.044.726.128 1.07C7.727 8.564 4.1 6.697 1.67 3.859a4.501 4.501 0 0 0-.666 2.358c0 1.627.87 3.063 2.19 3.904a5.091 5.091 0 0 1-2.23-.586v.059c0 2.272 1.697 4.168 3.95 4.6a5.16 5.16 0 0 1-2.224.08c.627 1.863 2.445 3.22 4.6 3.257a10.195 10.195 0 0 1-6.115 2.008c-.398 0-.79-.022-1.175-.065a14.444 14.444 0 0 0 7.548 2.107c9.057 0 14.01-7.147 14.01-13.346 0-.204-.005-.406-.015-.607A9.76 9.76 0 0 0 24 5.2" />
    </symbol>
    <symbol
      viewBox="0 0 24 24"
      id="verified_user"
    ...
    <symbol viewBox="0 0 24 24" id="website" xmlns="http://www.w3.org/2000/svg">
      <path d="M14.384 2.174l-1.908.168-.897-.138-.616.91-1.797.093-1.124-.305-1 .515-2.168.285-1.737.472H3.13C5.367 1.624 8.755 0 12.543 0c1.861 0 3.618.404 5.196 1.103l-.437.062-1.198-.17-.847.532-.592.614.882.174.982.885.304.786.227.736 1.563 1.416.402.129.555-.89 1.964-.176.369-.118A12.373 12.373 0 0 1 24 11.973 12.366 12.366 0 0 1 14.57 24l.224-.818 2.116-1.42.555-1.519 1.461-.683 1.385-2.659-2.141-1.265-1.11-1.266-.654-.077-1.31-.354-1.129-.179-.988.28-.605-.684-.605-.178.05-.91-.73.023-.416.482-.238-1.013.955-.456.984.456h.529l.191-.785L14.565 9.2l2.043-1.037 1.183.152.107-.581-1.466-1.495-.553-1.114h-.808l-.504-.296-1.084-.16-.227 1.293-1.312-.254-.1-.81 1.008-.229.331-1.452 1 .414-.026.617.762.32.509.15.624-.328-.555-.658L14.36 2.62l.023-.446zm-.354 15.929s.578 1.919.579 1.995c0 .075-.578 2.298-.578 2.298l.131 1.496a13.42 13.42 0 0 1-1.579.108C5.633 24 0 18.468 0 11.648c0-2.274.636-4.396 1.727-6.225l.906-.206-.908.707.712.457H3.85l2.099-.367 1.322 2.11v1.971l1.803 2.4h.307v-.846l.694 1.426 2.093.461.945.931.84.247-.84 1.72.916 1.669zm.354-15.929l.272-.024.009-.009-.277-.054-.004.087zm-1.325-1.032l-.716.42.498.303 1.106-.104 1.16-.83-.801-.435-1.247.646zm-3.692.094c-.018.137-.8.61-.8.61l.8.44 1.663-.41-.392-.64-.72.215-.551-.215z" />
    </symbol>
