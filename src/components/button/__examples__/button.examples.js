...
export const examples = [
  {
    ...
    html:
      '<button class="ui-btn ui-btn--tertiary ui-btn--medium">Tertiary Button</button>',
  },
  {
    ...
    html:
      '<button class="ui-btn ui-btn--primary ui-btn--medium">Primary button</button>',
  },
  {
    ...
    html:
      '<button class="ui-btn ui-btn--secondary ui-btn--medium">Secondary button</button>',
  },
  {
    title: 'Delete Button',
